...
import styles from "./JobfairCarousel.module.sass";

import Icon from "../../../../components/Icon";
import Modal from "../../../../components/Modal";
import { jobfair as content } from "../../../../mocks/jobfair";
      ...
      <div className="container">
        ...
        <div className={styles.buttonWrapper}>
          {content.map((e, i) => (
            ...
            >
              <Icon name={e.icon} size={24} viewBox="0 0 24 24" className={styles.icon}/>
              <span>{e.title}</span>
            </button>
          ))}
        </div>
