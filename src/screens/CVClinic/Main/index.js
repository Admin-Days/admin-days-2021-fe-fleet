        ...
        <div className={styles.preview}>
          <picture>
            <source
              ...
              srcSet="/assets/cvclinic-hero.jpg"
            />
            <img src="/assets/cvclinic-hero.jpg" alt="Main" />
          </picture>
          <div className={styles.wrap}>
            <h1 className={cn("hero", styles.title)}>
              CV Clinic & HRD Discussion Class
            </h1>
            <div className={cn("info", styles.info)}>
              How to succeed in presenting the best version of you
            </div>
          </div>
        </div>
